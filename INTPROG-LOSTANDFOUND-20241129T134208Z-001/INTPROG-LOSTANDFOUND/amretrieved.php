...
$retrieved_items = $conn->query("SELECT * FROM retrieved_items");
...
<nav>
    ...
    <div class="admin-dashboard">
        <h1>Retrieved Items</h1>
        <button class="btn-add" id="btnAddRetrievedItem">ADD RETRIEVED ITEM</button>
        <table>
            <thead>
                <tr>
                    <th>Item Name</th>
            ...
            <tbody>
                <?php while($row = $retrieved_items->fetch_assoc()): ?>
                    <tr>
                        <td><?php echo $row['item_name']; ?></td>
                        <td><?php echo $row['description']; ?></td>
                        <td><?php echo $row['location']; ?></td>
                        <td><?php echo $row['date_retrieved']; ?></td>
                        <td>
    ...
    <div id="addItemModal" class="modal">
        <div class="modal-content">
            ...
            <h2>Add Retrieved Item</h2>
            <form id="addItemForm" method="POST" action="add_retrieved_item.php" enctype="multipart/form-data">
                ...
                <label for="addDateRetrieved">Date Retrieved:</label>
                <input type="datetime-local" name="date_retrieved" id="addDateRetrieved" required>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            <span class="close">&times;</span>
            <h2>Edit Item</h2>
            <form id="editForm" method="POST" action="edit_retrieved_item.php" enctype="multipart/form-data">
                ...
                <label for="editDateRetrieved">Date Retrieved:</label>
                <input type="datetime-local" name="date_retrieved" id="editDateRetrieved">
    ...
    <script>
        ...
        document.getElementById("btnAddRetrievedItem").onclick = function() {
        ...
        document.querySelectorAll(".btn-view").forEach(button => {
            button.addEventListener("click", (e) => {
                ...
                fetch(`view_retrieved_item.php?id=${id}`)
        ...
        document.querySelectorAll(".btn-edit").forEach(button => {
            button.addEventListener("click", (e) => {
                const id = e.target.dataset.id;
                fetch(`get_retrieved_item.php?id=${id}`)
                    ...
                    .then(data => {
                        ...
                        document.getElementById("editDateRetrieved").value = data.date_retrieved.replace(' ', 'T');
        ...
        document.querySelectorAll(".btn-delete").forEach(button => {
            button.addEventListener("click", (e) => {
                ...
                document.getElementById("confirmDelete").onclick = function() {
                    fetch(`delete_retrieved_item.php?id=${id}`)
                        .then(response => {
                            if (response.ok) {
                                location.reload();
                            }
