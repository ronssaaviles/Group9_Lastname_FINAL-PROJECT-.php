...
<nav>
    ...
    <div class="admin-dashboard">
        <h1>Found Items</h1>
        <button class="btn-add" id="btnAddFoundItem">ADD FOUND ITEM</button>
        <table>
            <thead>
                <tr>
                    <th>Item Name</th>
    ...
    <div id="addItemModal" class="modal">
        <div class="modal-content">
            ...
            <form id="addItemForm" method="POST" action="add_found_item.php" enctype="multipart/form-data">
                ...
                <label for="addDateFound">Date Found:</label>
                <input type="datetime-local" name="date_found" id="addDateFound" required>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            <span class="close">&times;</span>
            <h2>Edit Item</h2>
            <form id="editForm" method="POST" action="edit_found_item.php" enctype="multipart/form-data">
                ...
                <input type="datetime-local" name="date_found" id="editDateFound">
...
document.getElementById("btnAddFoundItem").onclick = function() {
...
document.querySelectorAll(".btn-view").forEach(button => {
    button.addEventListener("click", (e) => {
        ...
        fetch(`view_found_item.php?id=${id}`)
...
document.querySelectorAll(".btn-edit").forEach(button => {
    button.addEventListener("click", (e) => {
        const id = e.target.dataset.id;
        fetch(`get_found_item.php?id=${id}`)
            ...
            .then(data => {
                ...
                document.getElementById("editDateFound").value = data.date_found.replace(' ', 'T');
...
document.querySelectorAll(".btn-delete").forEach(button => {
    button.addEventListener("click", (e) => {
        ...
        document.getElementById("confirmDelete").onclick = function() {
            fetch(`delete_found_item.php?id=${id}`)
                .then(response => {
                    if (response.ok) {
                        location.reload();
                    }
